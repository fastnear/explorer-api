...
```bash
curl -X POST https://tx.main.fastnear.com/v0/transactions \
  ...
  "account_txs": [
    {
      ...
      "tx_index": 0,
      "is_signer": true,
      "is_delegated_signer": false,
      "is_real_signer": true,
      "is_any_signer": true,
      "is_predecessor": true,
      "is_explicit_refund_to": false,
      "is_receiver": false,
      "is_real_receiver": false,
...
```bash
curl -X POST https://tx.main.fastnear.com/v0/receipt \
  -H 'Content-Type: application/json' \
  -d '{
...
```json
{
  "receipt": {
    ...
    "block_timestamp": "...",
    "receipt_index": 0,
    "appear_block_height": 0,
    "appear_receipt_index": 0,
    "transaction_hash": "...",
    "tx_block_height": 0,
    "tx_block_timestamp": "...",
    "tx_index": 0,
